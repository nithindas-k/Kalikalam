...
export interface IAudioService {
    ...
    updateAudio(id: string, dto: UpdateAudioDTO, creatorId: string, isAdmin?: boolean): Promise<AudioResponseDTO>;
    deleteAudio(id: string, creatorId: string, isAdmin?: boolean): Promise<void>;
