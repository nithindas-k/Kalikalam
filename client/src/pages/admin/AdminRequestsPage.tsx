        ...
        <div className="min-h-screen bg-background">
            ...
            <main className="max-w-4xl mx-auto px-4 py-12">
                <header className="mb-10 text-center">
                    ...
                    <h1 className="text-4xl font-bold tracking-tight text-white mb-2">Registration Requests</h1>
                    <p className="text-muted-foreground">Manage pending administrative access requests</p>
                </header>
                ...
                {isLoading ? (
                    ...
                    <Card className="bg-card/50 border-white/5 backdrop-blur-sm p-12 text-center rounded-[2rem]">
                            ...
                            <Card key={request._id} className="bg-card/40 border-white/5 backdrop-blur-sm hover:border-orange-500/20 transition-all rounded-[1.5rem] overflow-hidden group">
                                <div className="p-6 sm:p-8 flex flex-col sm:flex-row items-center justify-between gap-6">
                                    <div className="flex items-center gap-5">
                                        <div className="w-14 h-14 rounded-2xl bg-orange-500/10 border border-orange-500/20 flex items-center justify-center text-orange-500 font-bold text-xl">
                                            {request.email.charAt(0).toUpperCase()}
                                        </div>
                                        <div>
                                            <h4 className="text-lg font-bold text-white group-hover:text-orange-400 transition-colors uppercase tracking-tight">{request.email}</h4>
                                    ...
                                    <div className="flex items-center gap-3 w-full sm:w-auto">
                                        <Button
                                            variant="outline"
                                            className="flex-1 sm:flex-none border-white/10 hover:bg-red-500/10 hover:text-red-500 hover:border-red-500/50 rounded-xl"
                                        ...
                                        <Button
                                            className="flex-1 sm:flex-none bg-orange-600 hover:bg-orange-500 text-white rounded-xl shadow-lg shadow-orange-900/20"
